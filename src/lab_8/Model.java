...
public class Model {
    public void calculate(String firstInput, String secondInput,
        ...
        errorMessage(firstInput, secondInput, output, firstException, secondException);
    }

    public static void errorMessage(String firstInput, String secondInput, Label output, Label firstException, Label secondException) {
        String errorMessage = "";
        float firstNumber = 0;
